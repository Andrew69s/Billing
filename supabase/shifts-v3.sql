...
--  Правило: план місяця можна вносити/коригувати до 3 числа наступного
--  місяця включно. Далі план замикається назавжди, вноситься лише факт.
--  Магазин може подати запит; ТМ/адмін підтверджує; після підтвердження
--  магазин коригує факт до кінця того дня, потім знову замок.
-- =========================================================
...
declare
  ...
  deadline timestamptz := date_trunc('month', wd::timestamp) + interval '1 month' + interval '3 days';
